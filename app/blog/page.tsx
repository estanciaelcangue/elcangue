    ...
    async function fetchData() {
      ...
      try {
        ...
        if (postsResult.error || eventsResult.error) {
          ...
          setErrorMessage("No pudimos cargar el contenido del blog en este momento.")
        }
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex items-center justify-center gap-4 text-card/80">
            ...
            <span className="font-sans text-sm uppercase tracking-widest">
              Novedades, Eventos y Experiencias
            </span>
            <span className="w-12 h-px bg-card/40" />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="font-sans text-foreground/60 mt-4">Cargando publicaciones...</p>
            </div>
            ...
            <div className="text-center py-12">
              <p className="font-sans text-foreground/60">No hay publicaciones en esta categoría.</p>
            </div>
          ) : (
